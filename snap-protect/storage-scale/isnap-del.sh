  ...
  if [[ ! -z $jobId ]]; then
    ...
    do
      ...
      sleep $sleeptime
        ...
        echo "  DEBUG: curl -k -X GET --header 'Accept: application/json' --header \"Authorization: Basic $apiAuth\" \"https://$apiServer/scalemgmt/v2/jobs?fields=%3Aall%3A&filter=jobId%3D$jobId\""
        sleep $sleeptime
