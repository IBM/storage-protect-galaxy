...
SELECT name, SPACE_SAVED_PCT, SPACE_SAVED_MB, USED_SPACE,
DEDUP_SAVED_MB, DEDUP_SAVED_PCT, COMP_SAVED_MB, COMP_SAVED_PCT FROM
TSMGUI_ALLSTG_GRID WHERE STG_TYPE=101 OR STG_TYPE=100 ORDER BY
